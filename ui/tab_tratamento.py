...
class TabTratamento:
    ...
    def _build(self, body):
        ...
        self._build_country_selector(left_inner)
        self._build_api_key_section(left_inner)
        self._build_separator(left_inner)
        self._build_format_selector(left_inner)
        self._build_separator(left_inner)
        self._build_output_dir(left_inner)
        self._build_separator(left_inner)
        self._build_drop_zone(left_inner)
        self._build_process_button(left_inner)
    ...
    def _on_pais_change(self):
        """Mostra/oculta seção de API key conforme país."""
